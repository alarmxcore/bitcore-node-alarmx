...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --daemon', 'Make bitcore-node-alarmx a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitcore-node-alarmx create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitcore-node-alarmx add wallet-service');
      console.log('    $ bitcore-node-alarmx add insight-api-alarmx');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitcore-node-alarmx remove wallet-service');
      console.log('    $ bitcore-node-alarmx remove insight-api-alarmx');
      console.log();
    });
